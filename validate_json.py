...
def get_draft(draft_name: str) -> type[jsonschema.Draft7Validator]:
    return [draft for names, draft in VALIDATOR_VERSIONS.items() if draft_name in names][0]
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--draft",
                        ...
                        choices=[*(v[0] for v in VALIDATOR_VERSIONS), *(v[1] for v in VALIDATOR_VERSIONS)],
                        default="v7",
